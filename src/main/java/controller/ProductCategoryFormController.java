...
import dto.tm.ProductCategoryTm;
...
public class ProductCategoryFormController {
    ...
    @FXML
    private TableView<ProductCategoryTm> tblProducts;
    ...
    private ObservableList<ProductCategoryTm> obList = FXCollections.observableArrayList();
    ...
    private void generateNextProductID() {
        try {
            ...
            String complainID = productsBO.generateNextProductID();
    ...
    private void loadAllProducts() {
        ...
        try {
            List<ProductCategoryDto> dtoList = productsBO.getAllProducts();
            for (ProductCategoryDto dto : dtoList){
                obList.add(
                        new ProductCategoryTm(
                                dto.getP_Id(),
                                dto.getName(),
                                dto.getType(),
                                dto.getQty(),
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        if (!isValidName){
            ...
            try {
                ...
                var dto = new ProductCategoryDto(id,name,type,qty,price);
                try {
    ...
    void btnUpdateOnAction(ActionEvent event) {
        ...
        if (!isValidName){
            ...
            try {
                ...
                var dto = new ProductCategoryDto(id,productName,type,qty,price);
                try {
